...
RUN (mkdir -p /liberty/usr/shared/resources/postgresql && cd /liberty/usr/shared/resources/postgresql && curl -O https://repo1.maven.org/maven2/org/postgresql/postgresql/42.6.0/postgresql-42.6.0.jar)
RUN configure.sh
